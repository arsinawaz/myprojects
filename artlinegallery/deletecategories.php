<?
	...
	if(isset($_POST['submit']))
	{
		...
		if($catId)
		{
			$response = $dataAccessObj->DeleteCategory($catId);
			if($response)
			{
				...
				echo"<script>alert('There was some problem deleting category.')</script>";
		}
		else
		{
...
<html lang="en">
<head>
<title>Admin Panel - Delete Categories</title>
<meta charset="utf-8">
...
<!-- content -->
				<section id="content">
					<div class="wrapper">
						...
						<form id="ContactForm" action=<?=$PHP_SELF?> method='POST' onsubmit="return ConfirmDeletion()">
							<div>
								<div class="wrapper">
								...
								<a href="#" class="button" onClick="document.getElementById('submit').click()">Delete</a>
