...
<script>
	...
	function ShowImages(catId)
	{
		...
		xmlhttp.onreadystatechange = function()
		{
			...
			if(xmlhttp.readyState == 4 && xmlhttp.status == 200)
			{
				...
				for(var j=0; j< imagesCount; j++)
				{
					...
					newTdImg.setAttribute("alt","Trash Image");
					newTdImg.setAttribute("width","15");
					newTdImg.setAttribute("height","15");
					newTdImg.setAttribute("title","move to trash");
					newTdImg.setAttribute("onclick","TrashImage("+imgId+")");
					...
					newTdImg11.setAttribute("title","Change Image");
					newTdImg11.setAttribute("onclick","ChangeImage("+imgId+")");
		...
		xmlhttp.open("POST","getimages.php?catId="+catId+"&deleted=no",true);
		xmlhttp.send();
	}
	function TrashImage(imgId)
	{
		alert("Trash Image "+imgId);
	}
	function ChangeImage(imgId)
	{
		alert("Change Image "+imgId);
	}
